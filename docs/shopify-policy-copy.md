# MetaliQ Art policy copy

These drafts are written for the current MetaliQ Art storefront and should be reviewed against the store's actual business practices before publication. They are not a substitute for advice from a qualified lawyer in the jurisdictions where the business operates or sells.
...
- Order and transaction details, including products ordered, custom design requirements, order value, payment status, delivery information, returns, and correspondence about an order.
- Account information if customer account features are enabled in the future.
- Communications you send to us, including enquiries, reviews, custom-design references, photographs, measurements, and other information you choose to provide.
- Device and usage information, such as browser type, IP address, device identifiers, pages viewed, referring pages, and interactions with the store.
- Marketing preferences and information about how you interact with our emails or advertisements.

Payment information is processed by Shopify and the payment providers available at checkout. We do not receive or store complete payment-card details.

### How we use information

We may use personal information to:

- Process payments, fulfil orders, arrange delivery, provide order updates, and handle returns or disputes.
- Develop and produce custom artwork based on the information and references you submit.
- Provide customer support and respond to questions.
- Maintain, secure, troubleshoot, and improve the Services.
- Detect or prevent fraud, misuse, security incidents, and unlawful activity.
- Send marketing communications where permitted and in line with your preferences.
- Measure store performance and understand how visitors use the Services.
...
Shopify processes information about store visitors and customers in accordance with its own privacy documentation. You can learn more at [Shopify's consumer privacy page](https://www.shopify.com/legal/privacy/consumers).

### Cookies and similar technologies

Our store and its service providers may use cookies and similar technologies to operate essential store functions, remember preferences, understand store performance, prevent fraud, and support marketing. The cookies used can vary depending on the Shopify features, apps, payment methods, and integrations enabled on the store.

You can manage cookies through your browser and, where available, through the store's privacy controls. Blocking some cookies may affect store functionality.

### Marketing communications

If you subscribe to marketing, we may send you news about products, custom work, and offers. You can unsubscribe using the link in a marketing email or by contacting us. Unsubscribing from marketing does not prevent operational messages about an order.

### Retention and security

We retain personal information only for as long as reasonably necessary for the purposes described in this policy, including fulfilling orders, maintaining business and tax records, resolving disputes, and meeting legal obligations. Retention periods vary by the type of information and the reason it is held.

We use reasonable administrative and technical safeguards, but no method of storage or transmission is completely secure. Please do not send sensitive payment or identity information through ordinary email or contact forms.

### Your choices and rights

Depending on where you live, you may have rights relating to your personal information, such as requesting access, correction, deletion, restriction, or a copy of certain information, or withdrawing consent where processing relies on consent. These rights may be subject to legal limitations.

To make a request, contact us using the details below. We may need to verify your identity before completing a request. You may also have the right to complain to the relevant data-protection or consumer authority in your jurisdiction.

### Children's privacy

The Services are not directed to children, and we do not knowingly collect personal information from children. If you believe a child has provided information to us, contact us so that we can review and, where appropriate, delete it.

### International processing

Shopify and other providers may process information outside Pakistan or outside the country where you live. Where required, the responsible provider uses recognised safeguards for international transfers.

### Changes to this policy

We may update this Privacy Policy to reflect changes to the Services, our practices, or legal requirements. The revised policy will be posted on this page with an updated date.
...
You must be legally capable of entering into a binding contract to place an order. You agree not to misuse the store, interfere with its security or operation, introduce malicious code, attempt unauthorised access, scrape the store in an abusive manner, or use the Services for unlawful activity.
...
Submitting an order is an offer to purchase. An order is accepted when we confirm acceptance or begin fulfilment, whichever occurs first. We may decline or cancel an order before acceptance because of availability, pricing or listing errors, suspected fraud, delivery limitations, or another reasonable operational issue. If payment has already been captured for an order we cancel, the relevant amount will be refunded through the original payment method where possible.

You are responsible for providing accurate contact, billing, delivery, and customisation information. Contact us promptly if you notice an error.
...
### 6. Custom and made-to-order work

For custom work, you are responsible for supplying accurate measurements, spellings, references, and instructions. Production begins only after the required details and any design approval have been received.

Design previews are for approval of composition and content and may not reproduce the exact physical finish or colour. Once you approve a design or production begins, changes may require an additional charge and may not always be possible. Custom and personalised items may not be cancellable or returnable except where they are defective, damaged, materially different from the approved design, or where applicable law requires otherwise.

### 7. Customer-provided material

You confirm that you have the right to submit and authorise us to use any names, images, artwork, logos, characters, text, or other material supplied for custom work. You must not ask us to reproduce content that infringes intellectual-property, privacy, publicity, or other rights.

You grant us a limited licence to use submitted material only as reasonably necessary to communicate with you, prepare the design, produce the order, and maintain order records. We may refuse a custom request that we reasonably believe is unlawful, harmful, offensive, unsafe, or infringing.

### 8. Intellectual property

The store and its original content, branding, product designs, graphics, photographs, text, and other materials are owned by or licensed to MetaliQ Art and are protected by applicable intellectual-property laws. Purchasing a physical product does not transfer copyright or other intellectual-property rights in the design.

You may not reproduce, manufacture, distribute, resell, or commercially exploit our designs or store content without written permission.
...
### 10. Installation and care

You are responsible for confirming that the wall, mounting hardware, and installation method are suitable for the artwork. Follow the supplied guidance and use fixings appropriate for the wall material and product weight. Use a qualified installer when uncertain. We are not responsible for damage caused by unsuitable fixings, an unsafe wall, incorrect installation, misuse, neglect, unauthorised modification, or failure to follow care guidance, except where liability cannot legally be excluded.
...
The store may use or link to third-party services, including Shopify, payment providers, carriers, social networks, and external websites. We do not control third-party services and are not responsible for their content, availability, or practices. Your use of them may be governed by separate terms and privacy policies.

### 13. Reviews and feedback

If you submit a review, photograph, suggestion, or other feedback for publication, you grant us a non-exclusive, worldwide, royalty-free licence to use, reproduce, edit for length or formatting, and display it in connection with MetaliQ Art and its marketing. You confirm that the submission is accurate to your experience and does not violate another person's rights. We will seek separate permission before identifying private custom references or using material beyond the scope reasonably expected when submitted.

### 14. Disclaimer and limitation of liability

To the fullest extent permitted by law, the Services are provided on an "as available" basis. We do not guarantee that the store will always be uninterrupted or error-free.

Nothing in these Terms excludes or limits liability that cannot legally be excluded. Subject to that qualification, MetaliQ Art will not be liable for indirect, incidental, special, or consequential loss arising from use of the store or a product. Where liability can lawfully be limited, our aggregate liability relating to an order will not exceed the amount paid for that order.

### 15. Indemnity

To the extent permitted by law, you agree to be responsible for losses or claims arising from your unlawful misuse of the Services, your breach of these Terms, or material you submit that violates another person's rights.
...
We may update these Terms by posting a revised version on the store. Changes apply from the stated effective date and do not retroactively change an accepted order unless required by law or agreed with you. If any provision is found unenforceable, the remaining provisions continue in effect.
